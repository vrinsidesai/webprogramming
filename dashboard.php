    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/wheather-beauty-salon/home" target="_blank">Google Site</a></li>
                    ...
                    <li class="list-group-item"><a href="https://github.com/vrinsidesai/webprogramming" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                ...
                <div class="container">
                    <div class="dashboard-item">
                        ...
                        <p><?php echo 'desai vrinsi' ?></p>
                    </div>
                    <div class="dashboard-item">
                        <div id="my-skillset" class="section-title">
                            <h2>My Skillset</h2>
                        </div>
                        <p><?php echo 'bca programmer' ?></p>
                    </div>
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                        <a href="https://github.com/vrinsidesai/webprogramming/tree/main/task" target="_blank"><button class="ocean-blue-button gradient-button">Task 1</button> </a>
<a href="https://github.com/vrinsidesai/webprogramming/tree/main/Task2" target="_blank"><button class="sunset-orange-button gradient-button">Task 2</button> </a>
<a href="https://github.com/vrinsidesai/webprogramming/tree/main/task3" target="_blank"><button class="spring-green-button gradient-button">Task 3</button></a>
<a href="https://github.com/vrinsidesai/webprogramming/tree/main/task4" target="_blank"><button class="royal-purple-button gradient-button">Task 4</button></a>
<a href="https://github.com/vrinsidesai/webprogramming/tree/main/task5" target="_blank"><button class="ruby-red-button gradient-button">Task 5</button></a>
